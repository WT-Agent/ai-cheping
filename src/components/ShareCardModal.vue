    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">汽车测评与选车指南</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 汽车测评与选车对比助手</span>
...
// 清理回复末尾的特殊标记 [CHEPING_SCORES]...[/CHEPING_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[CHEPING_SCORES\][\s\S]*?\[\/CHEPING_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 汽车测评与选车对比指南专家】\n\n${cleanContent.value}\n\n体验车评AI助手：https://ai.wuxian.xyz`;
